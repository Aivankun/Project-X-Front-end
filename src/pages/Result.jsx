...
//   const [hasFeedback, setHasFeedback] = useState(false); // State for feedback existance
...
//     try {
//       setHasFeedback(true); // Set feedback state to false
//       setIsLoading(true); // Set loading state to true
//       const response = await axios.get(`http://localhost:5000/api/result`);
//       console.log(response.data.feedback);
//       setFeedback(response.data.feedback); // Set feedback state
//       setComment(response.data.comment); // Set comment state
//       setScore(response.data.score); // Set score state
