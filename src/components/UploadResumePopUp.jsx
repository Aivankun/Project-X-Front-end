...
const UploadResumePopUp = ({ isVisible, closePopup, isError, startMockInterview }) => {
          ...
          {isLoading ? (
            ...
            >
              <div className="upload-content">
                ...
                {retrying && <p className="warning-message">An error has occurred. Please upload your file again.</p>} {/* Warning message */}
              </div>
